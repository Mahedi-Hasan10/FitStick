...
const PricingCard = ({Title, pricing, duration}) => {
    return (
        <div className="max-w-[424px] border border-white p-10 mb-4 group cursor-pointer">
           ...
           <div className="flex items-center justify-center">
            <MyButton buttonName="Get Membership" btnBG="border border-[#FF4E25] group-hover:bg-[#FF4E25] transition duration-300 "/>
           </div>
        </div>
    );
};
