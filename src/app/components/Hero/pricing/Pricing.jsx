...
const Pricing = () => {
    ...
    return (
        <section className=''>
            <h2 className='lg:text-5xl md:text-3xl text-2xl lg:font-bold md:font-semibold font-medium lg:leading-[57px] leading-[30px] text-center'>The Right plan on pricing</h2>
            <div className="flex gap-6 justify-center lg:mt-8 mt-4 lg:mb-[60px] mb-10 text-lg font-bold">
                <h5 className={`${!duration ? 'text-[#FF4E25]':'text-white'}`}>Monthly</h5>
                    <Switch defaultChecked onClick={handleDuration}/>
                <h5 className={`${duration ? 'text-[#FF4E25]':'text-white'}`}>Yearly</h5>
            </div>
