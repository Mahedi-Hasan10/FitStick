...
const Schedule = () => {
      ...
      {eventData ? (
        <tbody className="border border-white">
          {eventData.data.map((item, j) => (
            <tr
              className="w-full text-center schedule border border-white"
              key={j}
            >
              <th className="lg:w-[120px] md:w-[120px] w-full border border-white lg:p-0 md:p-0 h-[80px] bg-primary text-white text-[12px] bg-[#FF4E25]">
                {item.time}
              </th>
        ...
        <td
          colSpan={8}
          className="text-center text-primary lg:text-[48px] text-[24px] font-bold border border-white"
        >
          Not Found Any Data
        </td>
      )}
  ...
  return (
    <div className="">
      <h1 className="lg:text-[48px] md:text-[35px] text-[30px] text-center lg:font-bold font-semibold lg:mb-[60px] mb-[30px] capitalize">
        join our class
      </h1>
      <div className="flex justify-between lg:mx-[47px] mb-[40px] overflow-x-auto">
        {events.map((item, i) => (
          <button
            key={i}
            className={`font-bold ${
              event === item ? "bg-[#FF4E25] text-white" : "text-black1"
            } py-[12px] px-[30px] hover:bg-[#FF4E25]`}
            onClick={() => {
              setEvent(item);
            }}
          >
