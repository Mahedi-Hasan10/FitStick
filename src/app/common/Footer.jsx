...
const Footer = () => {
    return (
        <footer className="bg-[#01060f] pt-[80px] ">
            ...
            <div className="flex flex-col mx-auto p-1 ">
                <div className="flex items-center justify-center">
                    <form className="max-w-[821px] w-full">
                        ...
                        <div className="flex items-center gap-3 mt-6">
                            ...
                            <MyButton buttonName="Subscribe" btnBG="bg-[#FE4e25]"/>
                        </div>
                    </form>
                </div>
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-[80px] gap-8 capitalize lg:py-[70px] md:py-[50px] py-10 relative ">
                    <div className="z-40">
                        ...
                        <p className="mb-2 text-base font-semibold leading-[150%] ">say in touch
                    ...
                    <Image src="/footerBG.png" alt="footerBG" height={300} width={500} className="absolute bottom-0 md:left-[25%] right-0 z-10"/>
                </div>

            </div>  
            <div className="flex items-center py-4 justify-center border-t border-t-white border-opacity-30 mt-3">
                <p className="text-sm font-bold text-center  capitalize">copyright 2023. all right reserved. <span className="text-[#FE4651]">Fitstick</span></p>           
            </div>  
            </div>
        </footer>
    );
